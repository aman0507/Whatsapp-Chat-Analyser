...
if(data!=""):
    ...
    if(Option=='View Chat Analytics'):
        if(df.shape[0]==0):
            st.markdown('<p style="color:{};text-align:center;">The File is Not a Chat File Please Enter a Whats App Chat File to Continue!</p>'.format( subheadcolor),unsafe_allow_html=True)
        else:        
